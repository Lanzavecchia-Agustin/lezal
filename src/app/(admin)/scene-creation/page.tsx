...
// Interfaces de Scene, SceneOption, Skill y Attribute
interface Skill {
  id: string;
  name: string;
  subskills: {
...
export default function CreateScenePage() {
  ...
  const getSubskillLabel = (id: string) => {
    for (const skill of skills) {
      ...
      if (subskill) {
        return subskill.name; // O puedes retornar otro string personalizado
      }
    }
  ...
  return (
    <div className="container mx-auto p-4 bg-teal-900">
      <h1 className="text-2xl font-bold mb-4">Crear Nueva Escena</h1>
          ...
          <div className="grid gap-4">
            ...
            <div>
              ...
              <Input
                ...
                type="number"
                value={scene.maxVote || ""}
                onChange={(e) => handleSceneChange("maxVote", e.target.value ? Number(e.target.value) : undefined)}
            ...
            <div className="grid gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleOptionChange("nextSceneId", { success: e.target.value })}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleOptionChange("nextSceneId", { failure: e.target.value })}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleOptionChange("nextSceneId", { partial: e.target.value })}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleOptionChange("roll", { difficulty: Number(e.target.value) })}
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) => handleOptionChange("lockedAttributeIncrement", { attribute: value })}
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleOptionChange("lockedAttributeIncrement", { increment: Number(e.target.value) })
                  }
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) => handleOptionChange("requirements", { attribute: value })}
            ...
            {scene.options.map((option, index) => (
              <Card key={index} className="mb-2 p-2">
                <div className="flex justify-between items-center">
                  ...
                  <div>
                    <Button variant="ghost" size="icon" onClick={() => editOption(index)}>
      ...
      <Button type="submit" onClick={handleSubmit} className="w-full mb-4">
        Crear Escena
      </Button>
    </div>
  );
